...
courseRouter.get("/get-featured", course_controller_1.getFeaturedCourses);
courseRouter.post("/edit-featured", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.addCourseToFeatured);
courseRouter.delete("/delete-featured", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.deleteCourseFromFeatured);
